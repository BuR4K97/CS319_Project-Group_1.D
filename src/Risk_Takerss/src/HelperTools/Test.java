...
public class Test {
	...
	public static void processDefaultRiskVisualTerritories(String imageFile, String dataFile) {
		...
		/**
		visualTerritories.get(0).color = new Color(249, 66, 6);
		visualTerritories.get(1).color = new Color(129, 255, 129);
		visualTerritories.get(2).color = new Color(63, 71, 204);
		visualTerritories.get(3).color = new Color(127, 127, 127);
		visualTerritories.get(4).color = new Color(185, 122, 87);
		visualTerritories.get(5).color = new Color(181, 229, 29);
		visualTerritories.get(6).color = new Color(163, 73, 163);
		visualTerritories.get(7).color = new Color(255, 201, 13);
		visualTerritories.get(8).color = new Color(199, 191, 230);
		visualTerritories.get(9).color = new Color(31, 224, 223);
		visualTerritories.get(10).color = new Color(13, 101, 102);
		visualTerritories.get(11).color = new Color(83, 37, 83);
		visualTerritories.get(12).color = new Color(149, 51, 4);
		**/
