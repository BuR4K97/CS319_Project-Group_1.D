...
import ModelClasses.DefaultRiskTerritory;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		processDefaultRiskTerritoryGraph(DefaultRiskMode.modelDataFileName);
		processDefaultRiskVisualTerritories("maps\\Risk.png", DefaultRiskMode.visualDataFileName);
